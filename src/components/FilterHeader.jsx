...
const FilterHeader = ({ state, dispatch }) => {
  ...
  return (
    <div
      className={` ${
        state.isCollided ? "max-h-0 p-0 opacity-0" : "max-h-40 p-2 opacity-100"
      } w-full flex justify-end border-b border-gray-200 transition-all duration-1000 ease-in-out mt-16`}
    >
